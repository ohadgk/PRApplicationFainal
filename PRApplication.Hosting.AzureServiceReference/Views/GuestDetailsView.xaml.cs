...
namespace PRApplication.Hosting.AzureServiceReference.Views
{
    ...
    /// </summary>
    public sealed partial class GuestDetailsView : MvxWindowsPage
    {
        ...
        private void MvxWindowsPage_SizeChanged(object sender, SizeChangedEventArgs e)
        {
                ...
                if (e.NewSize.Width == 768)
                    VisualStateManager.GoToState(this, "TabletState", false);
                else
                    VisualStateManager.GoToState(this, "PcState", false);
        }
    }
}
